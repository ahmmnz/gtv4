...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        title.setText("GTV Kumanda v2.1 - KESIN CALISAN\nSes: " + vol + " Kanal: " + ch);
        ...
        volUp.setOnClickListener(v -> {
            if (vol < 100) vol++;
            title.setText("Ses: " + vol + " Kanal: " + ch);
            Toast.makeText(this, "VOL_UP", Toast.LENGTH_SHORT).show();
        });
        ...
        volDown.setOnClickListener(v -> {
            if (vol > 0) vol--;
            title.setText("Ses: " + vol + " Kanal: " + ch);
            Toast.makeText(this, "VOL_DOWN", Toast.LENGTH_SHORT).show();
        });
        ...
        chUp.setOnClickListener(v -> {
            ch++;
            title.setText("Ses: " + vol + " Kanal: " + ch);
            Toast.makeText(this, "CH_UP", Toast.LENGTH_SHORT).show();
        });
        layout.addView(chUp);
        ...
        chDown.setOnClickListener(v -> {
            if (ch > 1) ch--;
            title.setText("Ses: " + vol + " Kanal: " + ch);
            Toast.makeText(this, "CH_DOWN", Toast.LENGTH_SHORT).show();
        });
